...
function createTimeline3() {
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(m22Static, mAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(i22Static, iAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(o22Static, oAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(t22Static, tAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(a22Static, aAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(e22Static, eAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 1,
      ...moveLetter(s22Static, sAnimated2),
      ease: Circ.easeOut,
      delay: 1,
    },
    "moveletter"
  ...
  tl3.to(
    ...
    {
      duration: 2,
      ...moveLetter(mFinalmobile, m2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
  ...
  tl3.to(
    ...
    {
      duration: 2,
      ...moveLetter(iFinalmobile, i2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
  ...
  tl3.to(
    ...
    {
      duration: 2,
      ...moveLetter(oFinalmobile, o2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
  ...
  tl3.to(
    ...
    {
      duration: 2,
      ...moveLetter(tFinalmobile, t2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
  ...
  tl3.to(
    ...
    {
      duration: 2,
      ...moveLetter(aFinalmobile, a2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
  ...
  tl3.to(
    ...
    {
      duration: 2,
      ...moveLetter(eFinalmobile, e2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
  ...
  tl2.to(
    ...
    {
      duration: 2,
      ...moveLetter(sFinalmobile, s2Animated2),
      ease: Circ.easeOut,
      delay: 0,
    },
    "moveletter2"
...
function createTimeline() {
  ...
  tl.to(
    [block1],
    { duration: 8, ...moveTo(visitedPosition, block1) },
    "scroll1"
  );
  ...
  tl.to(
    [block2],
    { duration: 20, ...moveTo(visitedPosition, block2), delay: 0 },
    "scroll1"
  );
  tl.to(
    [lottieOne],
    { duration: 20, ...moveTo(prevLottie, lottieOne), delay: 6 },
    "scroll1"
  );
  ...
  tl.to(
    [block3],
    { duration: 36, ...moveTo(visitedPosition, block3), delay: 4 },
    "scroll1"
  );
  tl.to(
    [lottieTwo],
    { duration: 30, ...moveTo(prevLottie, lottieTwo), delay: 8 },
    "scroll1"
  );
  ...
  tl.to(
    [block4],
    { duration: 24, ...moveTo(finalPosition, block4), delay: 14 },
    "scroll1"
  );
  tl.to(
    [lottieThree],
    { duration: 20, ...moveTo(activeLottie, lottieThree), delay: 18 },
    "scroll1"
  );
...
function mobileScroll() {
  ...
  mtl.to(
    [block2],
    { duration: 18, ...moveTo(visitedPosition, block2), delay: 0 },
    "scroll1"
  );
  mtl.call(playLottie, [2]);
  mtl.to(
    [lottieOne],
    { duration: 20, ...moveTo(prevLottie, lottieOne), delay: 8 },
    "scroll1"
  );
  ...
  mtl.to(
    [block3],
    { duration: 24, ...moveTo(visitedPosition, block3), delay: 6 },
    "scroll1"
  );
  mtl.to(
    [lottieTwo],
    { duration: 30, ...moveTo(prevLottie, lottieTwo), delay: 10 },
    "scroll1"
  );
  ...
  mtl.to(
    [block4],
    { duration: 24, ...moveTo(finalPosition, block4), delay: 15 },
    "scroll1"
  );
  mtl.to(
    [lottieThree],
